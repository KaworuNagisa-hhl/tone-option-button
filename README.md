...
```bash
ohpm install @kaworunagisa_hhl/tone-option-button
```
...
```ts
import { SwiftUIToneOptionButton } from '@kaworunagisa_hhl/tone-option-button'
...
完整最小示例见 `example/SwiftUIToneOptionButtonUsage.ets`。该示例演示了可选色调、当前选中状态和点击切换，适合主题设置页。
